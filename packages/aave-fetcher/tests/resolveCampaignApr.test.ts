...
test('AMOUNT_PER_VALUE: without rewardTokenPrice returns 0', () => {
  const r = resolveCampaignApr(
    { apr: 0, distributionSettings: { apr: 18.25 } },
    'FIX_REWARD_AMOUNT_PER_LIQUIDITY_VALUE',
  );
...
test('AMOUNT_PER_VALUE: rewardTokenPrice = 0 returns 0', () => {
  const r = resolveCampaignApr(
    { apr: 0, distributionSettings: { apr: 18.25 } },
    'FIX_REWARD_AMOUNT_PER_LIQUIDITY_VALUE',
    0,
...
test('AMOUNT_PER_AMOUNT: missing rewardTokenPrice returns 0', () => {
  const r = resolveCampaignApr(
    { apr: 0, distributionSettings: { apr: 3650 } },
    'FIX_REWARD_AMOUNT_PER_LIQUIDITY_AMOUNT',
    undefined,
...
test('AMOUNT_PER_AMOUNT: missing targetTokenPrice returns 0', () => {
  const r = resolveCampaignApr(
    { apr: 0, distributionSettings: { apr: 3650 } },
    'FIX_REWARD_AMOUNT_PER_LIQUIDITY_AMOUNT',
    0.001,
...
test('AMOUNT variant without distributionSettings.apr returns 0', () => {
