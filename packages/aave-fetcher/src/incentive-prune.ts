...
function pruneMerklBreakdown(
  b: MerklCampaignBreakdown
): MerklCampaignBreakdown {
  return {
    ...
    ...(b.whitelistOnly !== undefined
      ? { whitelistOnly: b.whitelistOnly }
      : {}),
    ...(b.pointsPerThousandUsd !== undefined
      ? { pointsPerThousandUsd: b.pointsPerThousandUsd }
      : {}),
    ...(b.rewardTokenSymbol ? { rewardTokenSymbol: b.rewardTokenSymbol } : {}),
    ...(b.rewardTokenIconUrl
      ? { rewardTokenIconUrl: b.rewardTokenIconUrl }
      : {}),
    ...
    ...(b.campaignType
      ...
      : {}),
    ...(b.positionCapNative !== undefined
      ? { positionCapNative: b.positionCapNative }
      : {}),
...
export function pruneMerklGroup(
  g: MerklOpportunityGroup
): MerklOpportunityGroup {
  return {
    link: g.opportunityId
      ? `https://app.merkl.xyz/opportunities/${g.opportunityId}`
      : "",
    ...(g.opportunityId ? { opportunityId: g.opportunityId } : {}),
    ...(g.name ? { name: g.name } : {}),
    ...(g.message ? { message: g.message } : {}),
    ...(g.netPositionConstraint !== undefined
      ? { netPositionConstraint: g.netPositionConstraint }
      : {}),
...
function pruneBrevisBreakdown(
  b: BrevisCampaignBreakdown
): BrevisCampaignBreakdown {
  return {
    campaignApr: b.campaignApr,
    campaignStartedAt: b.campaignStartedAt,
    ...
    ...(b.positionCapUsd !== undefined
      ? { positionCapUsd: b.positionCapUsd }
      : {}),
    ...(b.isCombineCap !== undefined ? { isCombineCap: b.isCombineCap } : {}),
    ...(b.rewardTokenSymbol ? { rewardTokenSymbol: b.rewardTokenSymbol } : {}),
  };
