...
const mockFullReserve = {
  ...
  meritSupplys: [{ link: 'test', breakdowns: [{ campaignApr: 0.01, campaignId: 'test-base', campaignStartedAt: '2024-01-01', campaignEndedAt: '2024-12-31' }] }],
  meritBorrows: [{ link: 'test', breakdowns: [{ campaignApr: 0.01, campaignId: 'test-base', campaignStartedAt: '2024-01-01', campaignEndedAt: '2024-12-31' }] }],
