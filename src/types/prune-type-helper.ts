...
export function validatePruneResult(
  ...
  const expectedFields: (keyof RuntimeReserveData)[] = [
    ...
    'tokenSymbol', 'tokenAddress', 'tokenPrice',
    'utilizationPct', 'aTokenAddress', 'vTokenAddress', 'supplyApy',
    'supplyDisabled', 'isFrozen', 'isPaused',
    'borrowApy', 'borrowDisabled', 'supplyIncentives',
    'borrowIncentives', 'decimals',
    'availableLiquidity',
    'totalVariableDebt',
    'reserveSize', 'supplyCap', 'borrowCap',
    'suppliable', 'borrowable',
