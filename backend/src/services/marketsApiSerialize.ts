...
export function serializeReserveForApi(reserve: RuntimeReserveData): MarketWithSpread {
  const out: MarketWithSpread = {
    ...
    ...(reserve.availableLiquidityUsd !== undefined ? { availableLiquidityUsd: reserve.availableLiquidityUsd } : {}),
    ...(reserve.totalVariableDebt ? { totalVariableDebt: reserve.totalVariableDebt } : {}),
    ...(reserve.totalVariableDebtUsd !== undefined ? { totalVariableDebtUsd: reserve.totalVariableDebtUsd } : {}),
    ...
    ...(reserve.suppliableUsd !== undefined ? { suppliableUsd: reserve.suppliableUsd } : {}),
    ...(reserve.borrowable ? { borrowable: reserve.borrowable } : {}),
    ...(reserve.borrowableUsd !== undefined ? { borrowableUsd: reserve.borrowableUsd } : {}),
